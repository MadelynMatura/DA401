...
```{r}
plot6 <- ggplot(Total21,aes( Spending_per_capita_log, Disease_Burden_Index_Scaled)) + geom_point(aes(col=region)) + labs(y= "Disease Burden Index", x= "Log Government Healthcare Spending per Capita (USD) in High Income") + geom_smooth(method = "lm")
plot6
```
...
```{r}
plot6 <- ggplot(Total22,aes( Spending_per_capita_log, Disease_Burden_Index_Scaled)) + geom_point(aes(col=region)) + labs(y= "Disease Burden Index", x= "Log Government Healthcare Spending per Capita (USD) in Lower-Middle Income ") + geom_smooth(method = "lm")
plot6
```
...
```{r}
plot6 <- ggplot(Total23,aes( Spending_per_capita_log, Disease_Burden_Index_Scaled)) + geom_point(aes(col=region)) + labs(y= "Disease Burden Index", x= "Log Government Healthcare Spending per Capita (USD) in Low Income") + geom_smooth(method = "lm")
plot6
```
...
```{r}
plot6 <- ggplot(Total24,aes( Spending_per_capita_log, Disease_Burden_Index_Scaled)) + geom_point(aes(col=region)) + labs(y= "Disease Burden Index", x= "Log Government Healthcare Spending per Capita (USD) in Upper-Middle Income") + geom_smooth(method = "lm")
plot6
```
...
```{r}
plot7 <- ggplot(Total25,aes( Spending_per_capita_log, Disease_Burden_Index_Scaled)) + geom_point(aes(col=Income_Group)) + labs(y= "Disease Burden Index", x= "Log Government Healthcare Spending per Capita (USD) in the Americas") + geom_smooth(method = "lm")
plot7
```
...
```{r}
plot8 <- ggplot(Total26,aes( Spending_per_capita_log, Disease_Burden_Index_Scaled)) + geom_point(aes(col=Income_Group)) + labs(y= "Disease Burden Index", x= "Log Government Healthcare Spending per Capita (USD) in Europe") + geom_smooth(method = "lm")
plot8
```
...
```{r}
plot9 <- ggplot(Total27,aes( Spending_per_capita_log, Disease_Burden_Index_Scaled)) + geom_point(aes(col=Income_Group)) + labs(y= "Disease Burden Index", x= "Log Government Healthcare Spending per Capita (USD) in Africa") + geom_smooth(method = "lm")
plot9
```
...
p10 <- ggplot(Total_LowIncome, aes(x = Universal_Legislation, y = Disease_Burden_Index_Scaled)) +
        geom_boxplot(fill= "purple") + labs (x= "Passed Universal Healthcare Legislation in Low and Lower Middle Income Countries",  y= "Disease Burden Index")
...
p10 <- ggplot(Total_HighIncome, aes(x = Universal_Legislation, y = Disease_Burden_Index_Scaled)) +
        geom_boxplot(fill= "light green") + labs (x= "Passed Universal Healthcare Legislation in High Income Countries",  y= "Disease Burden Index")
...
```{r}
p10 <- ggplot(Total_MiddleIncome, aes(x = Universal_Legislation, y = Disease_Burden_Index_Scaled)) +
        geom_boxplot(fill= "light pink") + labs (x= "Passed Universal Healthcare Legislation in Upper Middle Income Countries",  y= "Disease Burden Index")
